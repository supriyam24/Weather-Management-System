...
public class Project extends JFrame implements ActionListener{
    Project(){
        super("WEATHER MANAGEMENT SYSTEM");
        
        setSize(1920,1030);
        
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\bg.jpg"));
        ...
        JMenuItem m1 = new JMenuItem("New Humid");
        JMenuItem m2 = new JMenuItem("New Sunny");
        master.setForeground(Color.BLUE);
        
        
        m1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\cloudy.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\sun.png"));
        ...
        JMenuItem u1 = new JMenuItem("Weather Details");
        JMenuItem u2 = new JMenuItem("Surrounding Details");
        user.setForeground(Color.RED);
        
        u1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\weather2.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\forest.png"));
        ...
        JMenuItem a1 = new JMenuItem("User Attendance");
        JMenuItem a2 = new JMenuItem("Researcher Attendance");
        attendance.setForeground(Color.BLUE);
        
        a1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\profile.png"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\profile.png"));
        ...
        JMenuItem b1 = new JMenuItem("User Attendance Detail");
        JMenuItem b2 = new JMenuItem("Researcher Attendance Detail");
        attendance_detail.setForeground(Color.RED);
        
        b1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\profile.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\profile.png"));
        ...
        JMenu exam = new JMenu("Survey");
        JMenuItem c1 = new JMenuItem("Survey Details");
        JMenuItem c2 = new JMenuItem("Enter Survey");
        exam.setForeground(Color.BLUE);
        
        c1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\survey.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\seo.png"));
        ...
        JMenuItem r1 = new JMenuItem("Update Users");
        JMenuItem r2 = new JMenuItem("Update Researchers");
        report.setForeground(Color.RED);
        
        r1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\profile.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\research.png"));
       ...
       /*JMenu fee = new JMenu("Fee Details");
        JMenuItem s1 = new JMenuItem("Subscription Structure");
        JMenuItem s2 = new JMenuItem("Subsription Form");
        fee.setForeground(Color.BLUE);
        
        s1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\subscription.png"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\forms.png"));
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\notepad.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\calculator.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\browser.png"));
        ...
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\information.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\logout.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Humid")){
            new AddStudent().f.setVisible(true);
            
        }else if(msg.equals("New Sunny")){
            new AddTeacher().f.setVisible(true);
            
        }else if(msg.equals("Weather Details")){
            new StudentDetails().setVisible(true);
            
        }else if(msg.equals("Surrounding Details")){
            new TeacherDetails().setVisible(true);
           
        }
        else if(msg.equals("Update Users")){
            new UpdateStudent().f.setVisible(true);
           
        }
        else if(msg.equals("Update Researchers")){
            new UpdateTeacher().f.setVisible(true);
           
        }
        else if(msg.equals("Subscription Structure")){
            new FeeStructure().setVisible(true);
           
        }
        else if(msg.equals("Subscription Form")){
        ...
        }else if(msg.equals("User Attendance")){
            new StudentAttendance().setVisible(true);
        }else if(msg.equals("Researcher Attendance")){
            new TeacherAttendance().setVisible(true);
        }else if(msg.equals("User Attendance Detail")){
            new StudentAttendanceDetail().setVisible(true);
        }else if(msg.equals("Researcher Attendance Detail")){
            new TeacherAttendanceDetail().setVisible(true);
        }else if(msg.equals("Survey Details")){
            new ExaminationDetails().setVisible(true);
        }else if(msg.equals("Enter Survey")){
