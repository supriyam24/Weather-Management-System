...
class UpdateTeacher implements ActionListener{
    ...
    UpdateTeacher(){
        f=new JFrame("Update Researcher details");
        f.setSize(900,650);
        f.setLocation(450,150); 
        f.setBackground(Color.white);
        f.setLayout(null);

        JLabel l1 = new JLabel("Enter Reseacher ID to update the data:");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update researcher set Name='"+t1.getText()+"',Last_Name='"+t2.getText()+"',Age='"+t3.getText()+"', DOB='"+t4.getText()+"',Address='"+t5.getText()+"',Phone='"+t6.getText()+"',Email_ID='"+t7.getText()+"',Qualification='"+t8.getText()+"',Course='"+t9.getText()+"',Aadhar_No='"+t10.getText()+"', Branch = '"+t11.getText()+"',Specialization='"+t13.getText()+"',Department='"+t14.getText()+"' where ID='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from researcher where ID = '"+t12.getText()+"'";
