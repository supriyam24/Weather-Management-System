...
public class TeacherAttendance extends JFrame implements ActionListener{
    ...
    TeacherAttendance(){
        ...
        try{
            conn c = new conn();
            ResultSet rs = c.s.executeQuery("select * from weather");
            while(rs.next()){
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String qry = "insert into researcher_attendance values("+ id +",'"+f+"','"+s+"')";
