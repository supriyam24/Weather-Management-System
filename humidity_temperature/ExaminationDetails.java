...
public class ExaminationDetails extends JFrame implements ActionListener{
   ...
   public ExaminationDetails() {
        ...
        JLabel l1 = new JLabel("Check Survey Result");
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Survey-Details",
