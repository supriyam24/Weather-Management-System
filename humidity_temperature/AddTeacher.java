...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\surr.jpg"));
        Image i3 = img.getImage().getScaledInstance(920, 600,Image.SCALE_DEFAULT);
        ImageIcon icc3 = new ImageIcon(i3);
        id15.setIcon(icc3);

        id8 = new JLabel("New Surrounding Details");
        ...
        id4= new JLabel("Date (dd/mm/yyyy)");  
        ...
        lab=new JLabel("Disaster");
        lab.setBounds(50,400,150,30);
	lab.setFont(new Font("serif",Font.BOLD,20));
        id15.add(lab);
            
        String course[] = {"Flood","Tsunami","Earthquake","Tornado","Landslide","NO"};
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"Weather Forecasting","Surrounding Analysis"};
        c2 = new JComboBox(branch);
        c2.setBackground(Color.WHITE);
        c2.setBounds(600,400,150,30);
        id15.add(c2);
        
        id11= new JLabel("User ID");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into surrounding values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"','"+m+"')";
                cc.s.executeUpdate(q);
                JOptionPane.showMessageDialog(null,"Surrounding Details Inserted Successfully");
                f.setVisible(false);
