...
class UpdateStudent implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id15,lab,lab1,lab2,id16;
    JTextField t,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14;
    JButton b,b1,b2; 
    String id_emp;

    UpdateStudent(){;
        f=new JFrame("Update User details");
        f.setSize(900,650);
        ...
        JLabel l1 = new JLabel("Enter ID to update the data of User");
        ...
        id8 = new JLabel("Update User Details:");
        ...
        f.add(t11);*/
        JLabel id13 = new JLabel("Specialization");
	...
	id13.setFont(new Font("serif",Font.BOLD,20));
        ...
        JLabel id14 = new JLabel("Branch");
        id14.setBounds(50,470,150,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                ...
                String str = "Update user set Name = '"+t1.getText()+"', Last_Name = '"+t2.getText()+"', Age = '"+t3.getText()+"', DOB = '"+t4.getText()+"', Address = '"+t5.getText()+"', Phone = '"+t6.getText()+"', Email_ID = '"+t7.getText()+"', Course = '"+t8.getText()+"',Qualification = '"+t9.getText()+"',Branch = '"+t14.getText()+"',Aadhar_No = '"+t10.getText()+"',Specialization = '"+t13.getText()+"' where ID = '"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from user where ID = '"+t12.getText()+"'";
