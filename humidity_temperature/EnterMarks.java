...
public class EnterMarks extends JFrame implements ActionListener{
    ...
    EnterMarks(){
        ...
        l1 = new JLabel("Enter Survey Details");
        ...
        l3 = new JLabel("Enter Location Name");
        l3.setBounds(50,150,200,40);
        add(l3);

        l4 = new JLabel("Enter Conditions");
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            if(ae.getSource() == b1){
                ...
                String s1 = "insert into location values('"+t1.getText()+"','"+t2.getText()+"','"+t4.getText()+"','"+t6.getText()+"','"+t8.getText()+"','"+t10.getText()+"')";
                String s2 = "insert into conditions values('"+t1.getText()+"','"+t3.getText()+"','"+t5.getText()+"','"+t7.getText()+"','"+t9.getText()+"','"+t11.getText()+"')";

                c1.s.executeUpdate(s1);
                c1.s.executeUpdate(s2);
                
                JOptionPane.showMessageDialog(null,"Survey Details Inserted Successfully");
