...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - XIE WEATHER FORECASTING");
            setBackground(new Color(173, 216, 230));
            setBounds(500, 250, 800, 500);
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("humidity_temperature\\icons\\information.png"));
            ...
            JLabel l3 = new JLabel("XIE");
            l3.setForeground(new Color(0, 250, 154));
            l3.setFont(new Font("Trebuchet MS", Font.BOLD | Font.ITALIC, 34));
            l3.setBounds(140, 40, 200, 55);
            contentPane.add(l3);

            JLabel l4 = new JLabel("Weather Mangement System");
            ...
            JLabel l6 = new JLabel("Developed By : GROUP 2");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Guided by: Prof Vijay Jumb");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : XIE TEAM FOR ENQUIRY");
            ...
            JLabel l10 = new JLabel("Thank you for using me!");
